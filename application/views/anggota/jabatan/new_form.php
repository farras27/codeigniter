			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('anggota/jabatan/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
					</div>
					<div class="card-body">

						<form action="<?php base_url('anggota/jabatan/add') ?>" method="post" enctype="multipart/form-data" >
							<div class="form-group">
								<label for="jabatan">Jabatan*</label>
								<input class="form-control <?php echo form_error('jabatan') ? 'is-invalid':'' ?>"
								 type="text" name="jabatan" placeholder="Nama jabatan" />
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('kode') ? 'is-invalid':'' ?>"
								 type="text" name="kode" min="0" placeholder="Kode jabatan" />
								<div class="invalid-feedback">
